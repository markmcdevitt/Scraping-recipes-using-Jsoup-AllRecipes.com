...
//		User u = new User();
//		//Recipe fakeRecipe = new Recipe("pineapple cake","this is food blah blah blah","imageURL","2", "352", category,fakeInstructions,ingredientList,"3");//this is the recipe being created 
...
//		User user1 = new User("Bob","bob@gmail.com", "letmein2",true,"ROLE_ADMIN",null,null,recipeList,fakeWeeklyPlan,list);// creates the user and has his favorites obeject with a list of recipes
...
//		
//		Recipe recipe = new Recipe("Spring Rolls","this is food blah blah blah 2","imageURL","1", "112", category,fakeInstructions,ingredientList,"4");
